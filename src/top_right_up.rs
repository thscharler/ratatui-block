...
use ratatui::symbols::border::{
    QUADRANT_BOTTOM_RIGHT, QUADRANT_LEFT_HALF, QUADRANT_TOP_LEFT_TOP_RIGHT_BOTTOM_RIGHT,
    QUADRANT_TOP_RIGHT,
};
use ratatui::widgets::BorderType;
use ratatui::widgets::BorderType::{QuadrantInside, QuadrantOutside};

pub(crate) fn top_right_up_joint(border: BorderType, kind: Joint) -> &'static str {
    use ratatui::widgets::BorderType::*;
