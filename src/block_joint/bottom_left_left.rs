...
use ratatui::symbols::border::{QUADRANT_TOP_HALF, QUADRANT_TOP_LEFT_BOTTOM_LEFT_BOTTOM_RIGHT};
use ratatui::widgets::BorderType;

pub(crate) fn bottom_left_left_joint(border: BorderType, joint: Joint) -> &'static str {
    use ratatui::widgets::BorderType::*;
