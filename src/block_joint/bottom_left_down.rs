...
use ratatui::symbols::border::{QUADRANT_RIGHT_HALF, QUADRANT_TOP_LEFT_BOTTOM_LEFT_BOTTOM_RIGHT};
use ratatui::widgets::BorderType;

pub(crate) fn bottom_left_down_joint(border: BorderType, joint: Joint) -> &'static str {
    use ratatui::widgets::BorderType::*;
    ...
    match (border, joint) {
        ...
        (QuadrantInside, _) => QUADRANT_RIGHT_HALF,
        (QuadrantOutside, _) => QUADRANT_TOP_LEFT_BOTTOM_LEFT_BOTTOM_RIGHT,
